...
fn main() {
    ...
    // types.h's SDLPOP_BINDGEN_WASM_STUB guard (c/sdl_stub.h, a minimal hand-written
    ...
    // exact set of top-level `extern` declarations in c/data.h.
    ...
    if is_wasm {
        // See types.h's SDLPOP_BINDGEN_WASM_STUB guard / c/sdl_stub.h's header comment:
